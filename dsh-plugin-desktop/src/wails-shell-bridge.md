...
| Setup/profile/recovery windows | AuxWindowService + native-ui prefer + scheme bridge | Hybrid UI; Recovery RPC keep-alive + snapshot/checkpoint/uninstall/diagnostics-export/quiesce; debt only when RPC/caps absent |
