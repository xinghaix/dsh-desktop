...
| Setup/profile/recovery windows | AuxWindowService + native-ui prefer + scheme bridge | Hybrid UI; checkpoint/uninstall schemes map to debt InfoDialog; Host API still missing |
