...
| Setup/profile/recovery windows | AuxWindowService + native-ui prefer + scheme bridge | Hybrid UI; Recovery RPC (`DSH_HOST_RECOVERY_RPC`) keep-alive + snapshot/checkpoint/uninstall; debt only when RPC absent |
